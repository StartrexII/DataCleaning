...
```
git clone https://github.com/StartrexII/DataCleaning.git
```
...
Рассмотренны основные методы очистки данных, а также популярные методы определения выбросов, основанные на математической статистике, которые эффективны, в основном, для идеальных распределений данных, в будущем будут добавлены другие способы, основанные на машинном обучении, которые более эффективны для реальных данных.
